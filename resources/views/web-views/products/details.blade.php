                    ...
                    <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                        <div class="details">
                            ...
                            <div class="mb-3">
                              ...
                              @if($product->per_unit_price)
                                <span class="{{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}"
                                    style="font-size: 12px;font-weight:400">
                                    (<span>₹{{$product->per_unit_price}} </span>)
                                </span>
                                @endif
                                <!--<span class="{{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}"
                                    style="font-size: 12px;font-weight:400">
								...
								<br/>
								<p><span class="{{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}"
                                    style="font-size: 12px;font-weight:400">
                                    Country Of Origin: {{$product->country_of_origin}}</span>
                                </span></p>
                                @endif
                            </div>
