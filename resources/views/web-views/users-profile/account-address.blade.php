                        ...
                        <div class="tab-content">
                            <div id="home" class="container tab-pane active"><br>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="zip">{{\App\CPU\translate('Pincode')}}</label>
                        ...
                        <section class="col-lg-6 col-md-6 mb-4 mt-5">
                            <div class="card" style="text-transform: capitalize;">
                                                ...
                                                <div class="modal-body">
                                                    <form id="updateForm">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                <label for="zip_code">{{\App\CPU\translate('Pincode')}}</label>
                                    ...
                                    <div class="card-body" style="padding: {{Session::get('direction') === "rtl" ? '0 13px 15px 15px' : '0 15px 15px 13px'}};">
                                        ...
                                        <div><span class="font-nameA"> <strong> {{\App\CPU\translate('Pincode')}} :</strong> {{$shippingAddress['zip']}}</span>
                                        </div>
