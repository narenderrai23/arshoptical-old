                        ...
                        @if ($digital_payment['status']==1)
                            ...
                            @php($config=\App\CPU\Helpers::get_business_settings('ccavenue'))
                                ...
                                <div class="col-md-6 mb-4" style="cursor: pointer">
                                    <div class="card">
                                        <div class="card-body" style="height: 100px">
                                      <form action="{{route('ccav-request-andler')}}" method="post"> 
                                        @csrf 
                                            <input type="hidden" name="tid" value="{{rand(10,9999999999999)}}">
										  <input type="hidden" name="merchant_id" value="{{$data->merchantId}}">
										  <input type="hidden" name="order_id" value="123654789">
                                            <input type="hidden" name="amount" value="{{$data->amount}}">
										  <input type="hidden" name="currency" value="INR">                                           
                                          <input type="hidden" name="redirect_url" value="{{route('paymentccavenue')}}">
