        ...
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <!-- Shipping methods table-->
                    ...
                    @php($storeOpenTime=\App\Model\StoreOpenTime::first())
                    <h2 class="h4 pb-3 mb-2 mt-5">Store Open Time - {{date('h:i A', strtotime($storeOpenTime->open_time))}} To {{date('h:i A', strtotime($storeOpenTime->close_time))}}</h2>
                                    ...
                                    <div id="accordion">
                                        <div id="collapseThree"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        for="exampleInputPassword1">Pickup Factility</label>
                                                    <select class="form-control" name="pickup_factility" required>
                                                    <option value="">-- select --</option>
                                                    <option value="1">Himself Pickup</option>
