...
<div class="col-md-6 mb-4" style="cursor: pointer">
                                    <div class="card">
                                      ...
                                      <form action="{{route('api.ccav-request-handler')}}" id="form1" method="post"> 
						 ...
						 <input type="hidden" name="amount" value="{{getAmount($deposit->final_amo)}}">
                                          ...
                                          <input type="hidden" name="redirect_url" value="{{route('api.paymentccavenue')}}">
                                                <input type="hidden" name="cancel_url" value="{{route('api.ccavenue-response')}}">
