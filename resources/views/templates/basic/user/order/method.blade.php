                        ...
                        <div class="col-sm-6 col-md-4 col-xl-3 dashboard--item-width">
                            <div class="card card cmn--card bg--body">
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    data-percent_charge="{{showAmount($data->percent_charge)}}" data-bs-toggle="modal" data-bs-target="#depositModal" class="btn btn--primary custom-success deposit">@lang('Pay Now')</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
