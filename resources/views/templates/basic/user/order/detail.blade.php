...
<div class="col-xxl-12 col-lg-12">
    <div class="dashboard-wrapper">
                    ...
                    <div class="deposit-content w-100">
                        <ul>
                            ...
                            <li>
                                ...
                                @else
                                <span>@lang('Advance Payment')</span>
                                @endif  
                            </li>
        ...
        <table class="table cmn--table">
			...
			<td class="pro-thumbnail" data-label="@lang('Product')">
                       
                            @php 
                            $imagepath= App\Models\ProductGallery::where('id',$detail->color_id)->first();
                            @endphp
                                
                              <img style="width: 100px;" src="{{ getImage(imagePath()['product']['gallery']['path'].'/'. $imagepath->image,imagePath()['product']['gallery']['size']) }}" alt="">
        ...
        <div class="total-wrapper">
            ...
            <div class="d-flex flex-wrap justify-content-between border-0">
                <strong>@lang('GST :')</strong><strong> {{ showAmount($order->tax) }} {{ $general->cur_text }}</strong>
            </div>
            <div class="d-flex flex-wrap justify-content-between border-0">
