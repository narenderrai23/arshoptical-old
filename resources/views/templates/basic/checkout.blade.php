    ...
    <div class="container">
        <form id="checkout-form" action="{{ route('user.checkout.order') }}" method="POST">
            ...
            <div class="row gy-4 gy-sm-5">
                ...
                <div class="col-lg-5">
                    <div class="checkout-cart-total order-summary">
                        <h6 class="border-bottom pb-2 checkout-title">@lang('Order detail')</h6>
                        <ul class="subtotal-area">
                            ...
                            <li class="border-bottom my-3 @if($data['totaltax'] == 0) d-none @endif">
                                <h6 class="title">@lang('GST')</h6>
                                <b class="text--base fs--14px"><span>{{ $general->cur_sym }}{{ getAmount($data['totaltax'])}}</span></b>
                            </li>
                        ...
                        <ul class="subtotal-area mt-3 grand-total">
                            <li class="border-bottom my-3">
                                <h6 class="title">@lang('Shipping Charge')</h6>
                                <b class="shipping-price text--base fs--14px"> <span>{{ $general->cur_sym }}0.00</span></b>
                            </li>
                            <li class="border-bottom my-3 grand-total" >
                                <h6 class="title">@lang('Grand Total')</h6>
                                <b class="grand-total-price text--base fs--14px"><span>{{ $general->cur_sym }}{{ $data['total']}}</span>
                                </b>
                            </li>
                        </ul>
                            ...
                            <div class="payment-methods d-flex flex-wrap mt-3" style="gap:10px">
                                <div class="d-flex flex-wrap" style="gap:25px">
                                    ...
                                    <div class="form-check form--check">
                                        ...
                                        <label for="cashOnDelivery" class="form-check-label">@lang('Advance Payment')</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="cmn--btn w-100 btn--sm mt-4 place-order w-100" form="checkout-form">@lang('Place order')</button>
                    </div>
                </div>
            </div>
        </form>
