<div class="row">
    ...
    <div class="col-lg-7">
        <div class="product-details-content">
            ...
            <div class="price">
                <span class="text--base">{{ $general->cur_sym }}{{ showAmount($price) - userDiscount($product->price)}}</span>
                @if ($product->discount != 0)
                <del class="text--danger">{{ $general->cur_sym }}{{ showAmount($product->price) - userDiscount($product->price)}}</del>
