                            ...
                            <ul class="text-end">
                                ...
                                <li>
                                    ...
                                    <span class="d-inline-block">
                                        ...
                                        @else
                                        <span class="d-inline-block">@lang('Advance Payment')</span>
                                        @endif </span>
                                </li>
                                <li>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @endphp
                                    <tr>
                                        <td>
                                            <span>{{ __(@$detail->product->name .' '. $detail->product->model_no .' '. $detail->color) }}</span>
                                        </td>
                                        <td>
                                    ...
                                    @endforelse
                                <tr>
                                    <td  class="text-end">Total Products : {{ __(count($order->orderDetail)) }}</td>
                                    <td  class="text-end">Qty : {{ __($count) }}</td>
                                    <td  class="text-end">@lang('Subtotal')</td>
                                ...
                                <tr>
                                    <td colspan="3" class="text-end">@lang('GST')</td>
                                    <td><span>{{ showAmount($order->tax) }} {{ $general->cur_text }}</span></td>
                                </tr>
                                <tr>
