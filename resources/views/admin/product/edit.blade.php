                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                         ...
                         <div class="form-group col-md-6">
                            <label class="form-control-label font-weight-bold">@lang('Model No')
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" name="model_no" class="form-control"  value="{{ $product->model_no }}" />
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                           ...
                           <div class="form-group col-md-6">
                            ...
                            <select  name="cats_id[]" multiple  id="select-gear">
                                <option value="" selected disabled>@lang('Select one')</option>
                                @foreach ($allCategory as $cats)
                                     @php
                                            $sel=in_array($cats->id, explode(',', $product->cats)) ? 'selected' : '';
                                     @endphp
                                   <option value="{{ $cats->id }}" {{$sel}} style="font-weight:bold;">{{$cats->name}}</option>

                                     @foreach ($cats->subcategories as $prod)
                                        @php
                                            $sel=in_array($prod->id, explode(',', $product->cats)) ? 'selected' : '';
                                        @endphp
                                        <option value="{{$prod->id}}" {{$sel}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$prod->name }}</option>
                                     @endforeach
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label font-weight-bold">@lang('GST')
                                    <span class="text-danger">*</span>
                                </label>
            ...
            <div class="card my-2">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control border-radius-5 nicEdit1" name="description">{{ $product->description }}</textarea>
                    </div>
                </div>
            </div>
            <div class="card my-2">
...
<div class="form-group col-md-6">
					...
					<input style="width:100%"  type="text" name="colorcode{{$gallery->id}}" value="{{ $gallery->color_code }}">
</div>
<div class="form-group col-md-6">
					<input style="width:100%" type="text" name="qty{{$gallery->id}}" value="{{ $gallery->qty}}">
</div>
</div>
...
<script>
$('#select-gear').selectize({hideSelected: false});
