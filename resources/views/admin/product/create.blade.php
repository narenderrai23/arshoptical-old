        ...
        <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="model_no" class="form-control"  value="{{ old('name') }}" />
                        </div>
                         ...
                         <div class="form-group col-md-6">
                            ...
                            <select  name="cats_id[]" multiple  id="select-gear">
                                ...
                                @foreach ($allCategory as $cats)
                                   <option value="{{ $cats->id }}" style="font-weight:bold;">{{$cats->name}}</option>
                                  @php
                                   
                                    $products = App\Models\SubCategory::where('category_id',$cats->id)->get();
                                   @endphp
            ...
            <div class="card my-2">
                <div class="card-header">
                    ...
                    <input type="file" id="files" name="files" multiple class="myfiles">
...
<script>
    ...
    $('.myfiles').change(function (e) {
      ...
      for(i=0;i<e.target.files.length;i++){
        ...
        var str=e.target.files[i].name;
       filename= str.substring(
    str.indexOf("-") + 1, 
    str.lastIndexOf(".")
);
   
         var reader = new FileReader(str);
                    ...
                    <div class="image-upload">
                        ...
                        <div class="avatar-preview">
                                <div class="profilePicPreview" style="background-image: url({{ getImage('/', imagePath()['product']['gallery']['size']) }})">
                                    ...
                                    <img src='`+e.target.result+`' style="width:300x;">
                                    <input type="hidden" name="myfiles[]" value="`+e.target.result+'filename'+e.target.fileName+`">
                                </div>
                            </div>
                            <div class="avatar-edit">
