    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
				 ...
				 <li class="sidebar-menu-item {{ menuActive('admin.users.newcustomers') }} ">
                                <a href="{{ route('admin.users.newcustomers') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('New Customers')</span>
		...
		<li class="sidebar-menu-item  {{ menuActive('admin.blogs*') }}">
                    <a href="{{ route('admin.blogs.index') }}" class="nav-link"
                        data-default-url="{{ route('admin.blogs.index') }}">
                        <i class="menu-icon las la-bars"></i>
                ...
                <li class="sidebar-menu-item  {{ menuActive('admin.request.quantity') }}">
                    <a href="{{ route('admin.request.quantity') }}" class="nav-link"
                        data-default-url="{{ route('admin.request.quantity') }}">
                        <i class="menu-icon las la-bug"></i>
                        <span class="menu-title">@lang('Upload Quantity') </span>
                    </a>
                </li>
            </ul>
