...
@section('panel')
    <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{route('admin.category.updateorder')}}">
                    @csrf
<div class="row">
    <div class="col-lg-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Name')">
                                    <div class="user">
                                        <div class="thumb">
                                            <img src="{{ getImage(imagePath()['categorybanner']['path'] . '/' . $category->image, imagePath()['categorybanner']['size']) }}" alt="@lang('image')">
                                        </div>
                                        <span class="name"><input type="hidden" value="{{__($category->id)}}" name="order[]"/>{{ __($category->name) }}</span>
                                    </div>
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="javascript:void(0)"  class="icon-btn btn--primary editButton"
                                        ...
                                        data-status="{{ __($category->status) }}"
                                         data-metatitle="{{ __($category->metatitle) }}"
                                          data-metadescription="{{ __($category->metadescription) }}"
                                           data-metakeywords="{{ __($category->metakeywords) }}"
                                        data-featured="{{ __($category->featured) }}"
                                        data-header="{{ __($category->header) }}"
                                        data-home="{{ __($category->home) }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                            data-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="header">
                    </div>
                     <div class="form-group">
                        <label class="form-control-label font-weight-bold">
                            @lang('Home')
                        ...
                        <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                            data-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="home">
                    </div> 
                </div>
        ...
        (function($) {
            ...
            $('.editButton').on('click', function() {
                ...
                if ($(this).data('header') == 1) {
                    modal.find('input[name=header]').bootstrapToggle('on');
                } else {
                    modal.find('input[name=header]').bootstrapToggle('off');
                }
                if ($(this).data('home') == 1) {
                    modal.find('input[name=home]').bootstrapToggle('on');
                } else {
                    modal.find('input[name=home]').bootstrapToggle('off');
                }

                var x = $(this).data('image');
                $(".profilePicPreview").css("background-image",
                    `url({{ asset('assets/images/categorybanner/${x}') }})`);
                modal.modal('show');
