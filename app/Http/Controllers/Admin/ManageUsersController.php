...
class ManageUsersController extends Controller {
    ...
    public function bannedUsers() {
	 ...
	 public function newUsers() {
        ...
        $emptyMessage = 'No new user found';
        $users        = User::newuser()->orderBy('id', 'desc')->paginate(getPaginate());
        return view('admin.users.list', compact('pageTitle', 'emptyMessage', 'users'));
    }
    ...
    public function emailDetails($id) {
	  ...
	  public function export()
     {
        ...
        fputcsv($handle, array('firstname', 'lastname', 'company', 'username','email', 'country_code', 'state','city','mobile', 'discount','status'));
	...
	//$json=json_decode($row['address'], true);
		
             fputcsv($handle, array($row['firstname'], $row['lastname'], $row['company'], $row['username'],$row['email'], $row['country_code'],$state,$city, $row['mobile'],$row['discount'], $row['status']));
        }
