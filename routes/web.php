...
Route::namespace ('Gateway')->prefix('ipn')->name('ipn.')->group(function () {
    ...
    Route::post('phonepe', 'PhonePe\ProcessController@ipn')->name('PhonePe');
...
Route::namespace ('Admin')->prefix('admin')->name('admin.')->group(function () {
	...
	Route::get('request-quantity', 'AdminController@requestQuantity')->name('request.quantity');
	Route::post('quantity-download', 'AdminController@quantityDownload')->name('quantity.download');
	Route::post('quantity-update', 'AdminController@quantityUpdate')->name('quantity.update');
	...
	Route::get('customers/newcustomers', 'ManageUsersController@newUsers')->name('users.newcustomers');
        ...
        Route::post('customer/send-email/{id}', 'ManageUsersController@sendEmailSingle')->name('users.email.single.post');
	...
	Route::get('customer/export', 'ManageUsersController@export')->name('users.export.method');
        ...
        Route::post('subscriber/send-email', 'SubscriberController@sendEmail')->name('subscriber.sendEmail.post');
        ...
        Route::prefix('category')->name('category.')->group(function () {
            ...
            Route::post('/update/', 'CategoryController@updateorder')->name('updateorder');
        ...
        Route::prefix('subcategory')->name('subcategory.')->group(function () {
            ...
            Route::post('/update/', 'SubCategoryController@updateorder')->name('updateorder');
        });
        ...
        Route::prefix('product')->name('product.')->group(function () {
         ...
         Route::prefix('blogs')->name('blogs.')->group(function () {
          ...
          Route::post('/update/{id}', 'BlogsController@update')->name('update');
          Route::get('blogs/destroy/{id}', 'BlogsController@destroy')->name('blogs.destroy');
        ...
        Route::name('orders.')->prefix('orders')->group(function () {
            ...
            Route::get('/detail-delete/{id}', 'ManageOrderController@orderDetailDelete')->name('detail.delete');
            Route::post('/detail-update', 'ManageOrderController@orderDetailUpdate')->name('detail.update');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
		 ...
		 // The callback url after a payment Ccavenue
          // The callback url after a payment Ccavenue
...
Route::post('ccav-request-handler', 'CcavenueController@ccavrequesthandler')->name('ccav-request-andler');
...
Route::get('/account_deletion', 'SiteController@accountDeletion')->name('account_deletion');
...
Route::get('/blog-details/{id}', 'SiteController@blogdetails')->name('blog-details');
